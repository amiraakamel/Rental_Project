...
public class OO_Rental extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtxtLocation.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jtxtLocation.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tanta", "Cairo", "Alex" }));
        ...
        House.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        House.setText("House");
        ...
        Flat.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        Flat.setText("Flat");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jtxtLocation, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void jbtnRentalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnRentalActionPerformed
       ...
       cCustomer iCustomer = new cCustomer(jtxtCustomer.getText(),jtxtFirstname.getText(),jtxtSurname.getText(),jtxtAddress.getText(),jtxtPostCode.getText() , jtxtTown.getText()
               , jtxtProveOfID.getSelectedItem().toString(),Double.parseDouble(jtxtDeposit.getText()),Double.parseDouble(jtxtDownPayment.getText()));
       
       cRental iRental = new cRental(Flat.getText(),House.getText(),Double.parseDouble(jtxtCost.getText()),jtxtNumberOfRoom.getSelectedItem().toString() ,jtxtLocation.getSelectedItem().toString());
       
       cUtilities iUtilities = new cUtilities(Double.parseDouble(jtxtLocalTax.getText()), Double.parseDouble(jtxtWaterBill.getText()) , Double.parseDouble(jtxtElectricity.getText()));
      ...
      "---------------------------------------------------------------------" + "\n");
      jrtReceipt.append("Customer ID" + "\t\t"+ iCustomer.getCustomerID() + "\n");
      jrtReceipt.append("Firstname" + "\t\t"+ iCustomer.getFirstname() + "\n");
      jrtReceipt.append("Surname" + "\t\t"+ iCustomer.getSurname() + "\n");
      jrtReceipt.append("Address" + "\t\t"+ iCustomer.getAddress() + "\n");
      jrtReceipt.append("Post Code" + "\t\t"+ iCustomer.getPostcode() + "\n");
      jrtReceipt.append("Prove Of ID" + "\t\t"+ iCustomer.getProvefID() + "\n");
      jrtReceipt.append("Town" + "\t\t"+ iCustomer.getTown() + "\n");
      jrtReceipt.append("---------------------------------------------------------------------" + "\n");
      jrtReceipt.append("Deposit" + "\t\t"+ iCustomer.getDeposit() + "\n");
      jrtReceipt.append("Down Payment" + "\t\t"+ iCustomer.getDownPayment() + "\n");
      jrtReceipt.append("Number Of Room" + "\t"+ iRental.getNumberofroom() + "\n");
      jrtReceipt.append("Location" + "\t\t"+ iRental.getLocation() + "\n");
      if(House.isSelected())
      jrtReceipt.append("Flat Or House" + "\t\t"+ iRental.getHouse() + "\n");
      else if(Flat.isSelected())
      jrtReceipt.append("Flat Or House" + "\t\t"+ iRental.getFlat()+ "\n");
      
      jrtReceipt.append("cost" + "\t\t"+iRental.getCost()+ "\n");
      jrtReceipt.append("Electricity" + "\t\t"+iUtilities.getElectricity() + "\n");
      jrtReceipt.append("Local Bill" + "\t\t"+iUtilities.getLocalTax() + "\n");
      jrtReceipt.append("Water Bill" + "\t\t"+iUtilities.getWaterBill() + "\n");
      jrtReceipt.append("---------------------------------------------------------------------" + "\n");
    ...
    private javax.swing.JCheckBox Flat;
    ...
    private javax.swing.JComboBox<String> jtxtLocation;
